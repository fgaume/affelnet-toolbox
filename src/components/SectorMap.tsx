...
const tousSecteursIcon = L.divIcon({
  html: `<svg viewBox="0 0 24 24" fill="#d97706" width="24" height="24" stroke="white" stroke-width="1"><path d="M12 3L1 9l11 6 9-4.91V17h2V9L12 3z"/><path d="M5 13.18v4L12 21l7-3.82v-4L12 17l-7-3.82z"/></svg>`,
  className: 'custom-marker-icon',
  iconSize: [24, 24],
  iconAnchor: [12, 24],
  popupAnchor: [0, -24],
